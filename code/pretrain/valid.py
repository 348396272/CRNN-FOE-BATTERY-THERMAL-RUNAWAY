...
#     val_list=[0]
    ...
    if pretrain:
        ...
        optimizer = optim.Adam(
            [
                # {'params': front_net_crnn.parameters(),'lr':1e-4,'momentum':0.9},
                # {'params': back_net_crnn.parameters(),'lr':1e-5,'momentum':0.9},
    ...
    for epoch in range(1):
        ...
        for i,(ini_state,t,Y_label,X0,Temp,Pressure) in enumerate(front_dataloader):
            ...
            #变步长
            t_front = utils.variable_step_tensor(t[0].min(), time_end, front_number).unsqueeze(0)
